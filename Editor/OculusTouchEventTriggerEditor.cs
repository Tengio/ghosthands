...
namespace UnityEditor.EventSystems {
    [CustomEditor(typeof(OculusTouchEventTrigger), true)]
    public class OculusTouchEventTriggerEditor : Editor {
        ...
        protected virtual void OnEnable() {
            ...
            string[] eventNames = Enum.GetNames(typeof(OculusTouchEventTriggerType));
